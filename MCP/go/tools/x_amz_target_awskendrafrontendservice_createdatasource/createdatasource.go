...
func CreatedatasourceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateDataSourceRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSKendraFrontendService.CreateDataSource", cfg.BaseURL)
		...
		var result models.CreateDataSourceResponse
...
func CreateCreatedatasourceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSKendraFrontendService_CreateDataSource",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatedatasourceHandler(cfg),
	}
}
