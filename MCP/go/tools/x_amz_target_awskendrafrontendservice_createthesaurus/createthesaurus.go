...
func CreatethesaurusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateThesaurusRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSKendraFrontendService.CreateThesaurus", cfg.BaseURL)
		...
		var result models.CreateThesaurusResponse
...
func CreateCreatethesaurusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSKendraFrontendService_CreateThesaurus",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatethesaurusHandler(cfg),
	}
}
