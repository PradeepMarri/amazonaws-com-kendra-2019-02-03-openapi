...
func BatchgetdocumentstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.BatchGetDocumentStatusRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSKendraFrontendService.BatchGetDocumentStatus", cfg.BaseURL)
		...
		var result models.BatchGetDocumentStatusResponse
