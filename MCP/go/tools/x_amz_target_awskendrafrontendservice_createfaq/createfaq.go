...
func CreatefaqHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateFaqRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSKendraFrontendService.CreateFaq", cfg.BaseURL)
		...
		var result models.CreateFaqResponse
...
func CreateCreatefaqTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSKendraFrontendService_CreateFaq",
		...
		mcp.WithString("FileFormat", mcp.Description("")),
		mcp.WithString("S3Path", mcp.Required(), mcp.Description("")),
