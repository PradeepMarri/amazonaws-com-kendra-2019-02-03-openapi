...
func CreatefeaturedresultssetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateFeaturedResultsSetRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSKendraFrontendService.CreateFeaturedResultsSet", cfg.BaseURL)
		...
		var result models.CreateFeaturedResultsSetResponse
...
func CreateCreatefeaturedresultssetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSKendraFrontendService_CreateFeaturedResultsSet",
		...
		mcp.WithString("FeaturedResultsSetName", mcp.Required(), mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatefeaturedresultssetHandler(cfg),
	}
}
