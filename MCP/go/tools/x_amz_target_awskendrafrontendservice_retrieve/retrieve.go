...
func RetrieveHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.RetrieveRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSKendraFrontendService.Retrieve", cfg.BaseURL)
		...
		var result models.RetrieveResult
...
func CreateRetrieveTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSKendraFrontendService_Retrieve",
