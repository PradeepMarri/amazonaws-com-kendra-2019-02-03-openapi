...
func DescribeprincipalmappingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DescribePrincipalMappingRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSKendraFrontendService.DescribePrincipalMapping", cfg.BaseURL)
		...
		var result models.DescribePrincipalMappingResponse
...
func CreateDescribeprincipalmappingTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    DescribeprincipalmappingHandler(cfg),
	}
}
